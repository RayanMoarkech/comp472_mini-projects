...
def main(rush_hours: list[RushHour], heuristic_used: int):
    ...
    for index, rush_hour in enumerate(rush_hours):
        ...
        # Search file name
        file_name = 'a-h' + str(heuristic_used) + '-search' + '-' + str(index+1) + '.txt'

        # Print initial board
        write_search_file(file_name=file_name, mode='w', f=heuristic, g=0, h=heuristic,
        ...
        while open_valid_states and not is_solved:
            ...
            write_search_file(file_name=file_name, mode='a', f=f, g=g, h=heuristic,
            ...
            successors = open_valid_states[0]['rushHour'].get_all_next_valid_states(open_valid_states[0]['vehicleInfo'])
